...
public class Upload_Flie extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upload__flie);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.textViewUploads:
                startActivity(new Intent(this, View_Files.class));
                break;
        }
    }
}
